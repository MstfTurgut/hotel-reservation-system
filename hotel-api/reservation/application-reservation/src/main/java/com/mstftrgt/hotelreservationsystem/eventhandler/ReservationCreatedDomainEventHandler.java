...
public class ReservationCreatedDomainEventHandler implements DomainEventHandler<ReservationCreatedDomainEvent> {

    private final IntegrationEventPublisher integrationEventPublisher;

    @Override
    public void handle(ReservationCreatedDomainEvent event) {
